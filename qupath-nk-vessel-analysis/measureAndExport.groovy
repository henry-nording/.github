...
for (entry in imageList) {
    try {
        ...
        summaryRows << [
            ...
            NK_count_zone_0_5um:   nZone05,    pct_zone_0_5um:    nkCount > 0 ? (nZone05     * 100.0 / nkCount) : Double.NaN,
            NK_count_zone_5_10um:  nZone510,   pct_zone_5_10um:   nkCount > 0 ? (nZone510    * 100.0 / nkCount) : Double.NaN,
            NK_count_zone_10_20um: nZone1020,  pct_zone_10_20um:  nkCount > 0 ? (nZone1020   * 100.0 / nkCount) : Double.NaN,
            NK_count_zone_over20um:nZoneOver20, pct_zone_over20um: nkCount > 0 ? (nZoneOver20 * 100.0 / nkCount) : Double.NaN,
...
def cols = ["Image","NK_count","small_vessels","large_vessels","vessels_total",
            ...
            "NK_count_zone_0_5um","pct_zone_0_5um","NK_count_zone_5_10um","pct_zone_5_10um",
            "NK_count_zone_10_20um","pct_zone_10_20um","NK_count_zone_over20um","pct_zone_over20um",
            "nonNK_count",
